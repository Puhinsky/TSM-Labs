...
unsigned long long generic_synthesis::get_minterm_number(unsigned long long input, unsigned long long state)
{
	return concat_values(input, state, _triggers_count);
}

generic_synthesis::generic_synthesis(table table, state_map state_map)
{
	_table = table;
