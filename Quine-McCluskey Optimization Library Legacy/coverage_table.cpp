...
bool quine_mc_cluskey::less_than_sdnf(const std::pair<minterm, row>& lhs, const std::pair<minterm, row>& rhs)
{
	return lhs.second.size() < rhs.second.size();
}

bool quine_mc_cluskey::less_than_tdnf(const std::pair<minterm, unsigned int>& lhs, const std::pair<minterm, unsigned int>& rhs)
{
